        ...
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <a
              ...
              className="bg-accent hover:bg-red-700 text-white font-semibold px-5 py-2.5 rounded-full inline-flex items-center gap-2 transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <a
              href="tel:+19049090916"
              className="bg-accent text-white p-2.5 rounded-full"
              aria-label="Call us"
            >
